...
from
	...
	else 1/0.05 end VAR_Inverse_of_ratio_avg_months_30day_delinquent_last_6months_to_avg_months_30day_delinquent_last_18months,
	...
	else 1/0.03571 end VAR_Inverse_of_ctb_avg_months_90day_delinquent_last_18months,
	...
	select a.varb, a.cnt
	from
	(select avg_ratio_totaldebt_to_creditlimit_last_3months varb, count(avg_ratio_totaldebt_to_creditlimit_last_3months) cnt
	from dbo.IndusTest
	group by avg_ratio_totaldebt_to_creditlimit_last_3months) a
	order by a.cnt desc 
