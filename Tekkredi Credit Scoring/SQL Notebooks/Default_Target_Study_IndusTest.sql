select * into dbo.IndusTest_Edit
from
	(select t_2.*, t_1.*
	from dbo.IndusTest_Model t_1
		...
		left join
			...
			from
				...
				from 
					...
					and c.Id = 'C1D6A597-E676-4171-8CD8-5E935FF85684'
					and a.CreditTypeId=b.Id) t ) t2
			group by CustomerId, Description) t3
		on b.CustomerId = t3.CustomerId
		where b.Id = 'C1D6A597-E676-4171-8CD8-5E935FF85684' ) t4
