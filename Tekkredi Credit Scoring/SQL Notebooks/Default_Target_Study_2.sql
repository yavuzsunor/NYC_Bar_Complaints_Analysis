select * into dbo.IndusTrain_Edit
from
	(select t_2.*, t_1.*
	from dbo.IndusTrain_Model t_1

	left join

	(select CustomerTransactionId, TransTime, CustomerId,
	max(cast(DefLast3 as int)) DefLast3, 
	max(cast(DefMon3 as float)) Def3, cast(avg(OccpMon3) as numeric(18,2)) AvgOccp3,
	max(cast(DefMon6 as float)) Def6, cast(avg(OccpMon6) as numeric(18,2)) AvgOccp6,
	max(cast(DefMon6_3 as float)) Def6_3, cast(avg(OccpMon6_3) as numeric(18,2)) AvgOccp6_3,
	max(cast(DefMon12 as float)) Def12, cast(avg(OccpMon12) as numeric(18,2)) AvgOccp12,
	max(cast(DefMon12_6 as float)) Def12_6, cast(avg(OccpMon12_6) as numeric(18,2)) AvgOccp12_6,
	max(cast(DefMon18 as float)) Def18, cast(avg(OccpMon18) as numeric(18,2)) AvgOccp18,
	max(cast(DefMon18_6 as float)) Def18_6, cast(avg(OccpMon18_6) as numeric(18,2)) AvgOccp18_6
	...
	from
			...
			or LEFT(RIGHT(t3.Performance, len(t3.Performance)-(DATEDIFF(month,'2010-01-01', b.CreatedDateTime)+1)), 6) like '%3%'
			or LEFT(RIGHT(t3.Performance, len(t3.Performance)-(DATEDIFF(month,'2010-01-01', b.CreatedDateTime)+1)), 6) like '%4%' then 1 else 0 end DefMon6,
			...
			RIGHT(LEFT(RIGHT(t3.Performance, len(t3.Performance)-(DATEDIFF(month,'2010-01-01', b.CreatedDateTime)+1)), 6), 3) Mon6_3,
			...
			or RIGHT(LEFT(RIGHT(t3.Performance, len(t3.Performance)-(DATEDIFF(month,'2010-01-01', b.CreatedDateTime)+1)), 6), 3) like '%4%' then 1 else 0 end DefMon6_3,
			...
			cast(LEN(RIGHT(LEFT(RIGHT(t3.Performance, len(t3.Performance)-(DATEDIFF(month,'2010-01-01', b.CreatedDateTime)+1)), 6), 3)) as float) OccpMon6_3,
			...
			or LEFT(RIGHT(t3.Performance, len(t3.Performance)-(DATEDIFF(month,'2010-01-01', b.CreatedDateTime)+1)), 12) like '%3%'
			or LEFT(RIGHT(t3.Performance, len(t3.Performance)-(DATEDIFF(month,'2010-01-01', b.CreatedDateTime)+1)), 12) like '%4%' then 1 else 0 end DefMon12,
			...
			RIGHT(LEFT(RIGHT(t3.Performance, len(t3.Performance)-(DATEDIFF(month,'2010-01-01', b.CreatedDateTime)+1)), 12), 6) Mon12_6,
			case when RIGHT(LEFT(RIGHT(t3.Performance, len(t3.Performance)-(DATEDIFF(month,'2010-01-01', b.CreatedDateTime)+1)), 12), 6) like '%K%' 
			or RIGHT(LEFT(RIGHT(t3.Performance, len(t3.Performance)-(DATEDIFF(month,'2010-01-01', b.CreatedDateTime)+1)), 12), 6) like '%I%' 
			or RIGHT(LEFT(RIGHT(t3.Performance, len(t3.Performance)-(DATEDIFF(month,'2010-01-01', b.CreatedDateTime)+1)), 12), 6) like '%3%'
			or RIGHT(LEFT(RIGHT(t3.Performance, len(t3.Performance)-(DATEDIFF(month,'2010-01-01', b.CreatedDateTime)+1)), 12), 6) like '%4%' then 1 else 0 end DefMon12_6,
			cast(LEN(REPLACE(REPLACE(RIGHT(LEFT(RIGHT(t3.Performance, len(t3.Performance)-(DATEDIFF(month,'2010-01-01', b.CreatedDateTime)+1)), 12), 6), '/', ''), '.', '')) as float)/
			cast(LEN(RIGHT(LEFT(RIGHT(t3.Performance, len(t3.Performance)-(DATEDIFF(month,'2010-01-01', b.CreatedDateTime)+1)), 12), 6)) as float) OccpMon12_6,
			...
			or LEFT(RIGHT(t3.Performance, len(t3.Performance)-(DATEDIFF(month,'2010-01-01', b.CreatedDateTime)+1)), 18) like '%3%'
			or LEFT(RIGHT(t3.Performance, len(t3.Performance)-(DATEDIFF(month,'2010-01-01', b.CreatedDateTime)+1)), 18) like '%4%' then 1 else 0 end DefMon18,
			...
			RIGHT(LEFT(RIGHT(t3.Performance, len(t3.Performance)-(DATEDIFF(month,'2010-01-01', b.CreatedDateTime)+1)), 18), 6) Mon18_6,
			case when RIGHT(LEFT(RIGHT(t3.Performance, len(t3.Performance)-(DATEDIFF(month,'2010-01-01', b.CreatedDateTime)+1)), 18), 6) like '%K%' 
			or RIGHT(LEFT(RIGHT(t3.Performance, len(t3.Performance)-(DATEDIFF(month,'2010-01-01', b.CreatedDateTime)+1)), 18), 6) like '%I%' 
			or RIGHT(LEFT(RIGHT(t3.Performance, len(t3.Performance)-(DATEDIFF(month,'2010-01-01', b.CreatedDateTime)+1)), 18), 6) like '%3%'
			or RIGHT(LEFT(RIGHT(t3.Performance, len(t3.Performance)-(DATEDIFF(month,'2010-01-01', b.CreatedDateTime)+1)), 18), 6) like '%4%' then 1 else 0 end DefMon18_6,
			cast(LEN(REPLACE(REPLACE(RIGHT(LEFT(RIGHT(t3.Performance, len(t3.Performance)-(DATEDIFF(month,'2010-01-01', b.CreatedDateTime)+1)), 18), 6), '/', ''), '.', '')) as float)/
			cast(LEN(RIGHT(LEFT(RIGHT(t3.Performance, len(t3.Performance)-(DATEDIFF(month,'2010-01-01', b.CreatedDateTime)+1)), 18), 6)) as float) OccpMon18_6
			...
			left join
				...
				from
					...
					from 
						...
						and c.Id in (select right(left(ca_customertransactionid, 37), 36) from IndusTrain_Model)
						and a.CreditTypeId=b.Id) t ) t2
				group by CustomerId, Description) t3
			on b.CustomerId = t3.CustomerId
			where b.Id in (select right(left(ca_customertransactionid, 37), 36) from IndusTrain_Model) ) t4
	group by CustomerTransactionId, TransTime, CustomerId) t_2

	on right(left(t_1.ca_customertransactionid, 37), 36) = t_2.CustomerTransactionId ) t_last

select *
from dbo.IndusTrain_Edit

select *
from dbo.IndusTest_Edit

(select right(left(ca_customertransactionid, 37), 36) from IndusTrain_Model)